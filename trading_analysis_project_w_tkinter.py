...
# ekrana horizantal olarak ilk olarak frame1 ekliyourm ardından 
# horizantal olarak bir ekran ekliyoruz ve ekrana da vertical olarak frame2 ve frame 3 ekliyoruz
window = tk.Tk()
...
# frame1: treeview, open trade button ekliyoruz 
...
# frame3: text editor (fundamental analysis), scroll bar ekliyoruz 
